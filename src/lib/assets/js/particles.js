	...
	return (
		...
		(n.prototype._checkResponsive = function () {
			...
			if (n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
				for (e in ((i = null), n.breakpoints))
					n.breakpoints.hasOwnProperty(e) && o <= n.breakpoints[e] && (i = n.breakpoints[e]);
				null !== i
		...
		(n.prototype._resize = function () {
			...
			(e.element.width = e.element.offsetParent.clientWidth * e.ratio),
				'BODY' === e.element.offsetParent.nodeName
		...
		(n.prototype.pauseAnimation = function () {
			...
			if (e._animation) {
				if (e.usingPolyfill) t.clearTimeout(e._animation);
					...
					(t.cancelAnimationFrame || t.webkitCancelAnimationFrame || t.mozCancelAnimationFrame)(
						e._animation
					);
				e._animation = null;
			}
		...
		(n.prototype._draw = function () {
			var e = this,
				...
				s = e.storage;
			'BODY' === n.offsetParent.nodeName && (r = t.innerHeight),
		...
		((i = function (n, i) {
			var o = this,
				...
				a = i.speed,
				s =
					i.color instanceof Array ? i.color[Math.floor(Math.random() * i.color.length)] : i.color;
			(o.context = n), (o.options = i);
			var l = e.querySelector(i.selector);
			(o.x = r() * l.offsetParent.clientWidth),
				'BODY' === l.offsetParent.nodeName
					? (o.y = r() * t.innerHeight)
		...
		(t.requestAnimFrame = (function () {
			var e =
				t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame;
			return (
				e ||
